...
using DynamicEcomDZ.Models;
using static DynamicEcomDZ.Controllers.DailyNeedsDetailController;

namespace DynamicEcomDZ.Controllers
{
    public class DailyNeedsDetailController : Controller
    {
        private readonly IConfiguration _config;
        public int Restaurantid;
        public string? subHeaderTitle = "";

        public DailyNeedsDetailController(IConfiguration config)
        {
            _config = config;
        }
