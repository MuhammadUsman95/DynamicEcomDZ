...
using static TestingMVC.Controllers.UsmanDetailController;

namespace TestingMVC.Controllers
{
    public class UsmanDetailController : Controller
    {
        private readonly IConfiguration _config;
        public int Restaurantid;

        public UsmanDetailController(IConfiguration config)
        {
            _config = config;
        }
        ...
        public async Task<IActionResult> Index(int id)
        {
            ...
            var viewModel = new UsmanDetailViewModel
            {
                Sliders = sliders,
                Products = products
